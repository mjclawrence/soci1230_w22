...
rank_tier_plot <- ggplot(mean_rank_tier_level, aes(x = pq, y = k_rank, 
  ...
  labs(x = "Parent Income", y = "Young Adult Income Rank",
          title = "Average Rank In Young Adult Income Distribution \nBy Parent Income Quintile And College Type",
...
rank_tier_plot2 + theme(legend.position = "bottom",
  ...
  scale_color_discrete(limits = c("Elite Colleges", "Other Four-Year Colleges", 
