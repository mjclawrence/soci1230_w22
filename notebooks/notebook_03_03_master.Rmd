...
As a refresher, start by finding the 10 strongest positive correlations with k_rank. Use the pooled correlations.
...
```{r}
tfs_correlations2 <- left_join(tfs_correlations, tfs_question_summary2)

positive <- tfs_correlations2 |> 
      filter(corr_type == "Pooled", 
             !str_detect(Summary, "cant"),
             !str_detect(Group_rev, "Z")) |> 
