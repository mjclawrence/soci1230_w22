...
write.csv(css_question_summary2, "/Users/lawrence/Desktop/shiny_example/css_question_summary_labels.csv", row.names = FALSE)
```

Join new labels to pooled correlations file

```{r}
# Drop wtdprop from question summary

css_question_summary2 <- css_question_summary2 |> 
  select(-wtdprop)

css_correlations2 <- left_join(css_question_summary2,
                               css_correlations)

write.csv(css_correlations2, "/Users/lawrence/Desktop/shiny_example/css_correlations2.csv",
          row.names = FALSE)
```
...
tfs_correlations2 <- left_join(tfs_question_summary2,
                               tfs_correlations)

write.csv(tfs_correlations2, "/Users/lawrence/Desktop/shiny_example/tfs_correlations2.csv",
          row.names = FALSE)
```
