...
```{r}
write.csv(tfs_correlations2, "../../data/tfs_correlations_withno.csv", row.names = FALSE)
```
...
```{r}
write.csv(tfs_correlations2_type, "../../data/tfs_correlations_withno_type.csv", row.names = FALSE)
```
...
write.csv(tfs_correlations_all, "../../data/tfs_correlations_all.csv")
```
