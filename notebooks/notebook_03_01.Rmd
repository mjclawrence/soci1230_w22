...
Need a way to see the distribution of a survey question (we'll use `FACPRV08` from the CSS) at points of a continuous mobility variable. What are our options?

Let's try finding quantiles with the `quantile()` function.
